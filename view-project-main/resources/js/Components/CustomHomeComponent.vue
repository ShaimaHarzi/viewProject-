<template>
    <div>
      ...
      from resources/vendor/vue-luma/pages/home.vue
    -->
        ...
        >
            <student-home-hero v-bind="headerContentComponentProps" />
        </fmv-box>
                ...
                <div class="row align-items-center">
                    ...
                    >
                        <div
                            class="rounded-circle bg-primary w-64 h-64 d-inline-flex align-items-center justify-content-center mr-16pt"
                        >
                            <md-icon class="material-icons text-white"
        ...
        <page-feedback :container-class="containerClass" />
    </div>
</template>

<script>
import { LumaHomePage } from "vue-luma";
